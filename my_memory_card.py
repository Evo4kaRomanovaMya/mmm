...
questions_list.append(Question('Какого цвета ёлка?', 'зеленая', 'синяя', 'розовая', 'черная'))
questions_list.append(Question('Для чего выращивают свиней?', 'На шашлыки пустить', 'Просто так', 'Молоко брать у них', 'Играть в гляделки'))
questions_list.append(Question('Зачем красная кнопка висит на стенах в общественных местах?', 'При пожаре вызовет спасателей', 'От нее играет лирическая музыка', 'суету устроить', 'Просто так'))
questions_list.append(Question('2948747237273484922397237234798237', 'БАЛДИ!!!', 'Это ошибка?', 'Что', '39485637389399584757890'))
questions_list.append(Question('Почему листья зеленые?', 'Содержат хлорофил', 'Погода хорошая', 'Они разве не синие?', 'Если небо голубое, то листья зеленые'))
questions_list.append(Question('Какая Фамилия у Ивана Крылова?', 'Крылов', 'Я не знаю', 'Носов', 'Чебупицын'))
